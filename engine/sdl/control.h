...
#define	CONTROL_DEFAULT1_START          1 + (JOY_LIST_FIRST + SDL_CONTROLLER_BUTTON_START)
#define	CONTROL_DEFAULT1_UP             1 + (JOY_LIST_FIRST + SDL_CONTROLLER_BUTTON_DPAD_UP)
#define	CONTROL_DEFAULT1_DOWN		1 + (JOY_LIST_FIRST + SDL_CONTROLLER_BUTTON_DPAD_DOWN)
#define	CONTROL_DEFAULT1_LEFT		1 + (JOY_LIST_FIRST + SDL_CONTROLLER_BUTTON_DPAD_LEFT)
#define	CONTROL_DEFAULT1_RIGHT		1 + (JOY_LIST_FIRST + SDL_CONTROLLER_BUTTON_DPAD_RIGHT)
#define	CONTROL_DEFAULT1_FIRE1		1 + (JOY_LIST_FIRST + SDL_CONTROLLER_BUTTON_B)
#define	CONTROL_DEFAULT1_FIRE2		1 + (JOY_LIST_FIRST + SDL_CONTROLLER_BUTTON_X)
#define	CONTROL_DEFAULT1_FIRE3		1 + (JOY_LIST_FIRST + SDL_CONTROLLER_BUTTON_Y)
#define	CONTROL_DEFAULT1_FIRE4		1 + (JOY_LIST_FIRST + SDL_CONTROLLER_BUTTON_LEFTSHOULDER)
#define	CONTROL_DEFAULT1_FIRE5		1 + (JOY_LIST_FIRST + SDL_CONTROLLER_BUTTON_A)
#define	CONTROL_DEFAULT1_FIRE6		1 + (JOY_LIST_FIRST + SDL_CONTROLLER_BUTTON_RIGHTSHOULDER)
#define	CONTROL_DEFAULT1_SCREENSHOT	SDL_SCANCODE_F12
#define	CONTROL_DEFAULT1_ESC            1 + (JOY_LIST_FIRST + SDL_CONTROLLER_BUTTON_BACK)
